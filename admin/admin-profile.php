...
<!-- Mirrored from coderthemes.com/hyper/saas/pages-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Apr 2024 21:13:04 GMT -->
<head>
        <meta charset="utf-8" />
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="orders.php" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="sellers.php" class="side-nav-link">
                                <i class="uil-comments-alt"></i>
                                <span> Sellers </span>
                            </a>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarProjects">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="apps-projects-list.html">All Jobs</a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col">
                                                        <div>
                                                            <h4 class="mt-1 mb-1 text-white"><?= $userItem['full_name']; ?></h4>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="text-center mt-sm-0 mt-3 text-sm-end">
                                                    <a href="profile-edit.php?id=<?= $userItem['id']; ?>">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-start">
                                            <p class="text-muted"><strong>Full Name :</strong> <span class="ms-2"><?= $userItem['full_name']; ?></span></p>

                                            <p class="text-muted"><strong>Mobile :</strong><span class="ms-2"><?= $userItem['mobile']; ?></span></p>

                                            <p class="text-muted"><strong>Email :</strong> <span class="ms-2"><?= $userItem['email']; ?></span></p>

                                            <p class="text-muted"><strong>Location :</strong> <span class="ms-2"><?= $userItem['location']; ?></span></p>

                                            <p class="text-muted"><strong>Languages :</strong>
                                                <span class="ms-2"><?= $userItem['language']; ?></span>
                                            </p>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card tilebox-one">
                                            <div class="card-body">
                                                ...
                                                <h2 class="m-b-20"><?php echo getTotalUsers(); ?></h2>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card tilebox-one">
                                            <div class="card-body">
                                                ...
                                                <h6 class="text-muted text-uppercase mt-0">Total Post</h6>
                                                <h2 class="m-b-20"><?php echo getTotalPosts(); ?></h2>
...
<!-- Mirrored from coderthemes.com/hyper/saas/pages-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Apr 2024 21:13:07 GMT -->
</html>
