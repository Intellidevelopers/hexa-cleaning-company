                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <?=  alertMessage(); ?>
                                                <form action="teamcode.php" method="POST" enctype="multipart/form-data">
                                                <?php
                                                ...
                                                $user = getById('team', checkParamId('id'));
                                                if($user['status'] == 200){
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name" value="<?= $user['data']['name']; ?>" class="form-control" data-provide="typeahead" placeholder="Name">
                                                        </div>
                                                    </div> <!-- end col -->
                                                    ...
                                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="bloodhound" name="position" value="<?= $user['data']['position']; ?>" class="form-control" type="text" placeholder="Manager etc...">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="instagram" value="<?= $user['data']['instagram']; ?>" class="form-control" data-provide="typeahead" placeholder="https://www.instagram.com/">
                                                        </div>
                                                    </div> <!-- end col -->
                                                    ...
                                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="bloodhound" name="facebook" value="<?= $user['data']['facebook']; ?>" class="form-control" type="text" placeholder="https://www.facebook.com/">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="twitter" value="<?= $user['data']['twitter']; ?>" class="form-control" data-provide="typeahead" placeholder="https://www.twitter.com/">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>                     
                                            </div><br>
                                            <button type="submit" name="updateTeam" class="btn btn-primary">Create Team</button>
                                            <?php
                                                            }else{
