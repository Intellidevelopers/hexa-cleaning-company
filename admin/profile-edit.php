                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Update Customer Details</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14">
                                            By adding <code>New Customer</code>, you can have control over the existing and current users in as well the users list.
                                        </p>
                                            ...
                                            <div class="tab-pane show active" id="form-row-preview">
                                                ...
                                                <div class="row g-2">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="full_name" value="<?= $user['data']['full_name']; ?>" id="inputname" placeholder="Name" required>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Language</label>
                                                            <input type="text" class="form-control" name="language" value="<?= $user['data']['language']; ?>" id="inputPassword4" placeholder="Language" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="email" value="<?= $user['data']['email']; ?>" id="inputEmail4" placeholder="Email" required>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Password</label>
                                                            <input type="password" class="form-control" name="password" value="<?= $user['data']['password']; ?>" id="inputPassword" placeholder="Password" required>
                                                        </div>
                                                    </div>
        
                                                    <div class="mb-3">
                                                        <label for="inputAddress" class="form-label">Location</label>
                                                        <input type="text" class="form-control" name="location" value="<?= $user['data']['location']; ?>" id="inputAddress" placeholder="1234 Main St" required>
                                                    </div>
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="number" name="mobile" value="<?= $user['data']['mobile']; ?>" class="form-control" id="inputCity" required>
                                                        </div>
                                                        
                                                        <div>
                                                                <label class="form-label">About</label>
                                                                <p class="text-muted font-13">
                                                                    About details goes here.
                                                                </p>
                                                                <textarea data-toggle="maxlength"  value="<?= $user['data']['about']; ?>" name="about" class="form-control" maxlength="225" rows="3" 
