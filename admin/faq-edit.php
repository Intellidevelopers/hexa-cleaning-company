                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <?=  alertMessage(); ?>
                                                <form action="faq-code.php" method="POST">
                                                ...
                                                <?php
                                                   ...
                                                   $user = getById('faq', checkParamId('id'));
                                                   if($user['status'] == 200){
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="question" value="<?= $user['data']['question']; ?>" class="form-control" data-provide="typeahead" placeholder="Title">
                                                        </div>
                                                    </div> <!-- end col -->
                                                    ...
                                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="bloodhound" name="answer" value="<?= $user['data']['answer']; ?>" class="form-control" type="text" placeholder="Technology,education...">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>                   
                                            </div>
                                                        <br>
                                                        <button type="submit" name="updateFaq" class="btn btn-primary">Update Faq</button>
                                                        <?php
                                                            }else{
