                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add Faq</h4>
                                        <p class="text-muted font-14">
                                            By adding <code>New Faq</code>, you can have control over the existing and current sellers in as well the customers list.
                                        </p>
                                                ...
                                                <form action="faq-code.php" method="post">
                                                    ...
                                                    <div class="row g-2"> 
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="question" placeholder="Faq question">
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Answer</label>
                                                            <input type="text" class="form-control" name="answer" placeholder="Faq answer">
                                                        </div>
                                                    </div>

                                                    
                                                    <button type="submit" name="createFaq" class="btn btn-primary">Create Faq</button>
                                                </form>                      
                                            </div> <!-- end preview-->
