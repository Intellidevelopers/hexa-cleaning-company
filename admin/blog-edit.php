            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="pricing.php" class="side-nav-link">
                                <i class="uil-comments-alt"></i>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit <i class="mdi mdi-postage-stamp:"></i></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <?=  alertMessage(); ?>
                                                ...
                                                <?php
                                                   ...
                                                   $user = getById('blog', checkParamId('id'));
                                                   if($user['status'] == 200){
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="title" value="<?= $user['data']['title']; ?>" class="form-control" data-provide="typeahead" placeholder="Title">
                                                        </div>
                                                    </div> <!-- end col -->
                                                    ...
                                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="bloodhound" name="tags" value="<?= $user['data']['tags']; ?>" class="form-control" type="text" placeholder="Technology,education...">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>
                                                <!-- end row -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="date" class="form-control" value="<?= $user['data']['date']; ?>" name="date" id="inputAddress2" placeholder="Published date">
                                                                </div>
                                                            </div> <!-- end col -->
                                                            <div class="col-lg-6 mt-3 mt-lg-0">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Quotes:</label>
                                                                    <input type="text" name="quotes" value="<?= $user['data']['quotes']; ?>" class="form-control" data-provide="typeahead"  placeholder="Quotes">
                                                                </div>
                                                            </div> <!-- end col -->
                                                        </div>
                                                        <div class="col-lg-6 mt-3 mt-lg-0">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="author" value="<?= $user['data']['author']; ?>" class="form-control" data-provide="typeahead"  placeholder="Quotes">
                                                                </div>
                                                            </div>
                                                        <!-- end row -->
                                                        <!--<div class="row">
                                                            <div>
                                                                ...
                                                                <p class="text-muted font-13">
                                                                    Blog details goes here.
                                                                </p>
                                                                <textarea data-toggle="maxlength" name="first_description" class="form-control" maxlength="825" rows="3" 
                                                                    placeholder="This description has a limit of 225 chars."></textarea>
                                                            </div>
                                                            <div>
                                                                <br>
                                                                <label class="form-label">Seecond Description</label>
                                                                <p class="text-muted font-13">
                                                                    Blog details goes here.
                                                                </p>
                                                                <textarea data-toggle="maxlength" name="second_description" class="form-control" maxlength="825" rows="3" 
                                                                    placeholder="This description has a limit of 825 chars."></textarea>
                                                            </div>

                                                            <!--<div class="row g-2">
                                                                <div class="col-sm-6">
                                                                    <label class="form-label">Post Image</label>
                                                                    <input class="form-control" name="blog_image" accept="image/*" type="file" id="image" required>
                                                                </div>
                                                            </div>-->
                                                ...
                                                <!-- end row -->                      
                                                        ...
                                                        <br>
                                                        <button type="submit" name="updateBlog" class="btn btn-primary">Update Post</button>
                                                        <?php
                                                            }else{
