                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="bloodhound" name="tags" class="form-control" type="text" placeholder="Technology,education...">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>
                                                <!-- end row -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="date" class="form-control" name="date" id="inputAddress2" placeholder="Published date">
                                                                </div>
                                                            </div> <!-- end col -->
                                                            <div class="col-lg-6 mt-3 mt-lg-0">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Quotes:</label>
                                                                    <input type="text" name="quotes" class="form-control" data-provide="typeahead"  placeholder="Quotes">
                                                                </div>
                                                            </div> <!-- end col -->
                                                        </div>
                                                        <div class="col-lg-6 mt-3 mt-lg-0">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" name="author" class="form-control" data-provide="typeahead"  placeholder="Quotes">
                                                                </div>
                                                            </div>
                                                        <!-- end row -->
                                                        <div class="row">
