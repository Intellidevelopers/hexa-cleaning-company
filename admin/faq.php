...
<head>
        <meta charset="utf-8" />
        <title>Faq | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="customers.php">Faq</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="create-faq.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Faq</a>
                                            </div>
                                            <div class="col-sm-7">
                                            ...
                                            <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    if(mysqli_num_rows($customers) > 0){
                                                        ...
                                                        <td>
                                                            <a href="faq-edit.php?id=<?= $userItem['id']; ?>" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="faq-delete.php?id=<?= $userItem['id']; ?>" 
        ...
        item.addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'faq-delete.php?id=' + userId;
                }
            });
        });
    });
