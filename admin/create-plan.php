                                                ...
                                                <form action="pricing-code.php" method="post">
                                                    ...
                                                    <div class="row g-2"> 
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="title" placeholder="Pricing plan">
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Amount</label>
                                                            <input type="text" class="form-control" name="amount" placeholder="Plan answer">
                                                        </div>
                                                    </div>
                                                    <div class="row g-2"> 
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputEmail4" class="form-label">Per / hour rate</label>
                                                            <input type="text" class="form-control" name="time_rate" placeholder="Pricing plan">
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Payment Link</label>
                                                            <input type="text" class="form-control" name="url" placeholder="Plan answer">
                                                        </div>
                                                    </div>
                                                    <div class="row g-2"> 
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputEmail4" class="form-label">Service  1</label>
                                                            <input type="text" class="form-control" name="service_1" placeholder="Pricing plan">
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Service 2</label>
                                                            <input type="text" class="form-control" name="service_2" placeholder="Plan service_2">
                                                        </div>
                                                    </div>
                                                    <div class="row g-2"> 
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputEmail4" class="form-label">Service  3</label>
                                                            <input type="text" class="form-control" name="service_3" placeholder="Pricing service_3">
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Service 4</label>
                                                            <input type="text" class="form-control" name="service_4" placeholder="Plan service_4">
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Service 5</label>
                                                            <input type="text" class="form-control" name="service_5" placeholder="Plan service_5">
                                                        </div>
                                                    </div>
                                                    
                                                    <button type="submit" name="createPlan" class="btn btn-primary">Create Plan</button>
                                                </form>                      
                                            </div> <!-- end preview-->
