            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="create-project.php" class="btn btn-danger rounded-pill mb-3"><i class="mdi mdi-plus"></i> Create Project</a>
                            </div>
                            <div class="col-sm-8">
...
if ($projects !== false && mysqli_num_rows($projects) > 0) {
    while ($userItem = mysqli_fetch_assoc($projects)) {
        // Fetch image data for the current project
        $sql_image = "SELECT project_image FROM projects WHERE id = " . $userItem['id'];
        $result_image = mysqli_query($conn, $sql_image);

        if ($result_image !== false && mysqli_num_rows($result_image) > 0) {
            $row_image = mysqli_fetch_assoc($result_image);
            $image_path = 'uploads/' . $row_image['project_image'];
        } else {
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    ...
                                    <div class="card-img-overlay">
                                        <div class="badge text-bg-secondary p-1"><?= $userItem['professional']; ?></div>
                                    </div>

                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title"><?= $userItem['title']; ?></a>
                                        </h4>
