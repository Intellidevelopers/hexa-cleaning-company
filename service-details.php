...
<!-- Mirrored from demo.voidcoders.com/htmldemo/hexa/main-files/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Apr 2024 17:34:50 GMT -->

<head>

        <meta charset="utf-8">
        <title>Service Details | Hexa Cleaning Agency</title>
                        ...
                        <div class="row">
                                <div class="col-md-7">
                                        <div class="service-details-single">
                                                ...
                                                <p>Pretium vulputate sapien nec sagittis aliquam malesuada bibendum arcu vitae. Dictum non
                                                        consectetur a erat. Tellus molestie nunc non blandit. Accumsan in nisl nisi scelerisque eu
                                                        ultrices vitae. Mus mauris vitae ultricies leo integer malesuada nunc. Morbi tincidunt augue
                                                        interdum velit euismod.</p>
                                                <div class="sd-img">
                                                        <img src="assets/img/about/service-details-img1.jpg" alt>
                                                </div>
                                                <p>Pretium vulputate sapien nec sagittis aliquam malesuada bibendum arcu vitae. Dictum non
                                                        consectetur a erat. Tellus molestie nunc non blandit. Accumsan in nisl nisi scelerisque eu
                                                        for the min sources ultrices vitae.</p>
                                                <ul>
                                                        <li><i class="flaticon-tick"></i> Daily office cleaning for many types of offices</li>
                                                        <li><i class="flaticon-tick"></i> Carpet cleaning and flooring maintenance</li>
                                                        <li><i class="flaticon-tick"></i> Daily House and Windows Cleaning</li>
                                                        <li><i class="flaticon-tick"></i> Remove Germs, Viruses, Bacteria & Odors</li>
                                                        <li><i class="flaticon-tick"></i> Friendly 24/7 customer service</li>
                                                </ul>
                                                ...
                                                <div class="row">
                                                        <div class="col-md-6">
                                                                <div class="sd-img">
                                                                        <img src="assets/img/about/service-details-img2.jpg" alt>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                                <div class="sd-img">
                                                                        <img src="assets/img/about/service-details-img3.jpg" alt>
                                                                </div>
                                                        </div>
                                                </div>
                                                <p>Morem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                                        ...
                                        <div class="footer-pages">
                                                ...
                                                <div class="page-links">
                                                        ...
                                                        <ul>
                                                                ...
                                                                <li><i class="flaticon-email con-icon"></i> <a href="https://demo.voidcoders.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="365f585059764f5943445b575f5a1855595b">[email&#160;protected]</a></li>
...
<!-- Mirrored from demo.voidcoders.com/htmldemo/hexa/main-files/service-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Apr 2024 17:34:53 GMT -->
